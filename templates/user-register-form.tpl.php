...
<div class="user-picture"><img src="<?php print base_path().path_to_theme(); ?>/images/avatar.png" /></div>
...
<section class="col-sm-9">    
    ...
    <?php print render($form['form_token']);  ?>
	 <?php print render($form['honeypot_time']);  ?>
...
<div class="row">    
<div class="col-lg-6"><?php print render($form['account']['name']); // print_r($form); ?></div>
